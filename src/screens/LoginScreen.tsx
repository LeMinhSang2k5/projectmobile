    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Unlock Performance</Text>
        </View>
        ...
        <View style={styles.glassPanel}>
          ...
          >
            {loading
              ...
              : <Text style={styles.loginBtnText}>{isSignUp ? 'ĐĂNG KÝ NGAY' : 'LOGIN NOW'}</Text>
            }
          </TouchableOpacity>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            {isSignUp ? 'Đã có tài khoản? ' : "Don't have an account? "}
          </Text>
          <TouchableOpacity onPress={() => setIsSignUp(s => !s)}>
            <Text style={styles.footerLink}>{isSignUp ? 'Đăng Nhập' : 'Sign Up'}</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
      </KeyboardAvoidingView>
